...
public final class Arrays {
    ...
    private final static ThreadLocalRandom RANDOM_TLR = ThreadLocalRandom.current();
     ...
     * @param newdDeepComponentType - the data type to cast the elements from source into.
     ...
     * @throws ArrayIndexOutOfBoundsException if an attempt to access data from the source array throws an
     *                                        exception
     ...
     * <li>float - [-{@value Float#MAX_VALUE}, {@value Float#MAX_VALUE})</li>
     * <li>double - [-{@value Double#MAX_VALUE}, {@value Double#MAX_VALUE})</li>
     * </ul>
     */
    public enum RandomPrimitive {
        BOOLEAN((Boolean b) -> RANDOM_TLR.nextBoolean()),
        BYTE((Byte b) -> (byte) RANDOM_TLR.nextInt(Byte.MIN_VALUE, Byte.MAX_VALUE + 1)),
        CHAR((Character c) -> (char) RANDOM_TLR.nextInt(Character.MAX_VALUE + 1)),
        SHORT((Short s) -> (short) RANDOM_TLR.nextInt(Short.MIN_VALUE, Short.MAX_VALUE + 1)),
        INT((Integer i) -> RANDOM_TLR.nextInt()),
        LONG((Long l) -> RANDOM_TLR.nextLong()),
        FLOAT((Float f) -> (float) RANDOM_TLR.nextDouble(-Float.MAX_VALUE, Float.MAX_VALUE)),
        DOUBLE((Double d) -> RANDOM_TLR.nextDouble(-Double.MAX_VALUE, Double.MAX_VALUE));
