 ...
 *
 * @param <T>
 *            the type of vertices that this Graph holds
 */
public abstract class Graph<T> implements java.io.Serializable {
	...
	protected abstract class Vertex implements Comparable<Vertex> {
		 ...
		 * 
		 * @param newLinks
		 *            - the set of new vertices to point to.
		 ...
		 *            - the additional set of vertices to point to.
	 ...
	 * 
	 * @param vertexValue
	 *            - the specified vertex value to look for
	 ...
	 *            - the vertex to add.
	 * @param links
	 *            - the set of vertices that <code>vertex</code> will point to.
	 ...
	 * 
	 * @param originVertex
	 *            - the first/origin vertex
	 * @param targetVertex
	 *            - the second/target vertex
	 * @param n
	 *            - the path length
	 * @return false if:
	 *         <ul>
