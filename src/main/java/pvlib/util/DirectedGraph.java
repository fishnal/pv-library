 ...
 *
 * @param <T>
 *            - The type of vertex that the graph will hold.
 */
public final class DirectedGraph<T> extends Graph<T> {
	...
	private class DirectedVertex extends Vertex {
		 ...
		 *            - the value of this vertex.
		 * @param links
		 *            - the vertices that this vertex will point to.
		 */
	 ...
	 * 
	 * @param vertex
	 *            - the vertex currently being looked at.
	 * @param cycleVertex
	 *            - the vertex to cycle from.
	 * @param cycleList
	 *            - the list of cycles from cycleVertex.
	 * @param path
	 *            - the current path that this method is currently pursuing.
