...
public class ComplexMatrix extends NumberMatrix<ComplexNumber> {
	...
	@Override
	public ComplexNumber subDeterminant(int startRow, int startColumn, int endRow, int endColumn) {
		ComplexNumber[][] data = new ComplexNumber[endRow - startRow][endColumn - startColumn];
